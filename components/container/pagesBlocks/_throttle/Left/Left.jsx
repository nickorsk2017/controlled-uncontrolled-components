...
export function Left() {
  ...
  return (
      <div className={styles.list}>
        ...
        <article>
          This component has ralated logic with component B.<br/>
          A ralated logic can be a storage managment or some events.<br/>
          That can be generate a some effects for performance.<br/><br/>
